...
Module Program
    ...
    End Function
    Private Function concatenar(valor1 As String, valor2 As String, valor3 As String, valor4 As String) As String
        Return concatenar(concatenar(valor1, valor2), concatenar(valor3, valor4))
    End Function
